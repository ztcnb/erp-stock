<template>
  <el-card shadow="never">
    <div class="query-bar">
      <el-input v-model="query.keyword" placeholder="供应商名称/编码" clearable style="width: 220px" @keyup.enter="load(1)" />
    ...
    <el-table v-loading="loading" :data="rows" stripe>
      ...
      <el-table-column label="操作" width="140" fixed="right">
        <template #default="{ row }">
          ...
          <el-popconfirm title="确定删除该供应商吗?" @confirm="onDelete(row.id)">
            <template #reference>
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑供应商' : '新增供应商'" width="480px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
        <el-form-item label="编码" prop="code">
          <el-input v-model="form.code" placeholder="如 GYS009" />
        </el-form-item>
...
import { supplierApi, type Row } from '@/api/base'
